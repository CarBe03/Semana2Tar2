...
switch ($_GET["op"]) {
    ...
    case 'insertar':
        ...
        $datos = array();
        $datos = $productos->insertar($Codigo_Barras, $Nombre_Producto, $Nombre_Producto);
    ...
    case 'actualizar':
        ...
        $Graba_IVA = $_POST["Graba_IVA"];
        $datos = array();
        $datos = $productos->actualizar($idProductos, $Codigo_Barras, $Nombre_Producto, $Nombre_Producto);
        echo json_encode($datos);
        break;
